...
def gerar_pdf_receita(
    ...
    c.setFont("Helvetica-Bold", 20)  # Ajuste do tamanho da fonte
    ...
    y_left = altura - 3 * cm  # Ajuste da posição vertical após o título
    y_right = altura - 3 * cm
    esp_line = 0.7 * cm
...
def main():
    ...
    with left_col:
        # Substituir o título "Gerador de Receituário Veterinário" por "VetyRx - Receituário Veterinário"
